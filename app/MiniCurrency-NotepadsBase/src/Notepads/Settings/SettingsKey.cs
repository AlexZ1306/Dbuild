...
namespace Notepads.Settings
{
    internal static class SettingsKey
    {
        ...
        internal static string MiniCurrencyUiScalePercentInt = "MiniCurrencyUiScalePercentInt";
        internal static string MiniCurrencyActiveCardBackgroundOpacityPercentInt = "MiniCurrencyActiveCardBackgroundOpacityPercentInt";
        internal static string MiniCurrencyCardBackgroundOpacityPercentInt = "MiniCurrencyCardBackgroundOpacityPercentInt";
